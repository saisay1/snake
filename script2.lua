...
local CustomTargets = {
    ...
    {Name = "gravestone", Color = Color3.fromRGB(180, 180, 180), Tab = "CRYPT",        Text = "Show Gravestone", StateKey = "GravestoneEnabled", ModeKey = "GravestoneMode"},
}
...
TabScroll.CanvasSize = UDim2.new(2.6, 0, 0, 0); TabScroll.ScrollBarThickness = 0
...
addCircle(Color3.fromRGB(255, 255, 255),"💀", "Crypt")
SwitchTab("Player")
